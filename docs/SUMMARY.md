...
- [ECS Design](architecture/ecs-design.md)
...
- [Verifiable AI: Ghost Pieces](advanced/ghost-pieces.md)
- [Zero-Knowledge Proofs](advanced/zk-proofs.md)
- [Complexity Budgets](advanced/complexity-budgets.md)

## Technical Reference

- [Cairo Contracts](reference/cairo-contracts.md)
- [Dojo ECS Components](reference/ecs-components.md)
- [Torii Indexer](reference/torii-indexer.md)
- [Giza AI Integration](reference/giza-integration.md)
